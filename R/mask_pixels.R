#' uncao cria uma mascara sobre o background ou foreground
#'
#' @description Esta funcao permite criar mascara sobre os pixels
#'   correspondentes ao background ou foreground
#' @usage mask_pixels(im,TargetPixels,TargetPixels2=NULL,plot=F)
...
#' @return Retorna uma imagem com uma máscara sobre os  pixels selecionados.
...
#'   MatrizSegentada2=segmentation(b,treshold = "otsu",fillHull = T
#'   ,selectHigher= F) display(MatrizSegentada2)
#'
...
mask_pixels=function(im,TargetPixels,TargetPixels2=NULL,plot=F){
  TargetPixels==1
